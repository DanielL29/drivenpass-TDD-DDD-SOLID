...
describe("credential entity", () => {
  it("should create a credential entity", async () => {
    ...
    const credential = Credential.create(createCredentialProps);
    ...
    expect(credential.password).toEqual(createCredentialProps.password);
  ...
  it("should throw an error if credential[title] is empty", async () => {
    ...
    expect(() => Credential.create(createCredentialProps)).toThrow(
